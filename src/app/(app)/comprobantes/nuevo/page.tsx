...
import { RegistrarComprobanteForm } from "@/features/comprobantes/components/RegistrarComprobanteForm";

export const metadata: Metadata = {
  title: "Registrar pago | HogarFinance IA",
};
      ...
      <header className="sticky top-0 z-40 flex items-center gap-3 border-b border-gray-100 bg-white/95 px-4 pb-3 pt-5 backdrop-blur">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-gray-500">
            Elegí la factura y subí el comprobante
          </p>
        </div>
      </header>
      <RegistrarComprobanteForm facturaIdInicial={factura} />
    </>
  );
}
