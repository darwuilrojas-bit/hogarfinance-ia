...
import { EditarComprobanteForm } from "@/features/gastos/components/EditarComprobanteForm";

export const metadata: Metadata = {
  title: "Editar gasto | HogarFinance IA",
};
      ...
      <header className="sticky top-0 z-40 flex items-center gap-3 border-b border-gray-100 bg-white/95 px-4 pb-3 pt-5 backdrop-blur">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-gray-500">
            Corregí los datos de este pago
          </p>
        </div>
      </header>
      <EditarComprobanteForm comprobanteId={id} />
    </>
  );
}
